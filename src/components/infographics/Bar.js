...
function Bar(props){
    ...
    return(
        <div className={"barHold"}>
            ...
            <div className={"bar"}>
                <div className={"barFill barFillWinners"} style={{backgroundColor:color, width:((props.dt.wins/(props.dt.wins+props.dt.losses))*100)+"%" }}>
                ...
                <div className={"barFill barFillLosers"} style={{backgroundColor:color, width:(props.dt.losses/(props.dt.wins+props.dt.losses))*100+"%" }}>
